...
public class UiTextStrings {
	...
	private ResourceBundle indexTermsBundle = null;
	...
	public String translate(String key) {
		uiBundle = createBundle("UiTerms", uiBundle);
		if (uiBundle != null) {
		...
		indexTermsBundle = createBundle("IndexTerms", indexTermsBundle);
		if (indexTermsBundle != null) {
			String s = getStringFromBundle(key, indexTermsBundle);
			if (s != null)
				return s;
		}
