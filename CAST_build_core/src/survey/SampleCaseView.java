...
public class SampleCaseView extends SamplePictView {
	static final protected Color kPaleGreen = new Color(0xDDFFDD);
	
	
	public SampleCaseView(DataSet theData, XApplet applet,
	...
	protected PeopleImages loadPictures(XApplet applet) {
		...
		int noOfOptions[] = {4, 3, 1};
		String optionName[] = {"stdCase", "fatCase", "wheeledCase", "rucksack"};
