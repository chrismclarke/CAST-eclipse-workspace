...
public class BasicBoxplotView extends BasicDataView implements BoxPlotConstants {
	...
	public BasicBoxplotView(DataSet theData, XApplet applet,
...
//-------------------------------------------------------------------
	...
	public void changeClasses(double class0Start, double classWidth) {
		//	only implemented for BasicHistoView
	}
