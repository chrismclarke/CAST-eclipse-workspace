...
public class HistoDragView extends CoreDragView {
//	static public final String HISTO_DRAG = "histoDrag";
	...
	public HistoDragView(DataSet theData, XApplet applet, NumCatAxis valAxis, String yKey) {
...
//-------------------------------------------------------------------
	...
	public void setStatus(String status) {
		...
		for (int i=0 ; i<classCount.length ; i++)
			classCount[i] = Double.parseDouble(st.nextToken());
...
//-------------------------------------------------------------------
	...
	public void setMeanSD(double targetMean, double targetSD) {
		...
		while (true) {
			...
			double histoMean = getMeanFromGraph();
			double histoSD = getSDFromGraph();
